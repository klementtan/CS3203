...
TEST_CASE("Modifies(DeclaredStmt, DeclaredVar)")
{
    ...
    {
        req(kb_sample->uses_modifies.isModifies(1, "x"));
        req(kb_sample->uses_modifies.isModifies(5, "x"));
        req(kb_sample->uses_modifies.isModifies(8, "y"));
        req(kb_sample->uses_modifies.isModifies(9, "z"));

        req(kb_trivial->uses_modifies.isModifies(4, "x"));
        req(kb_trivial->uses_modifies.isModifies(5, "y"));
        req(kb_trivial->uses_modifies.isModifies(15, "count"));
        req(kb_trivial->uses_modifies.isModifies(20, "flag"));
        req(kb_trivial->uses_modifies.isModifies(21, "cenX"));
        req(kb_trivial->uses_modifies.isModifies(23, "normSq"));
    }

    SECTION("Modifies(DeclaredStmt, DeclaredVar) inside if/while")
    {
        req(kb_sample->uses_modifies.isModifies(4, "x"));
        req(kb_sample->uses_modifies.isModifies(4, "y"));
        req(kb_sample->uses_modifies.isModifies(4, "z"));
        req(kb_sample->uses_modifies.isModifies(6, "y"));
        req(kb_sample->uses_modifies.isModifies(6, "z"));
        req(kb_sample->uses_modifies.isModifies(13, "i"));
        req(kb_sample->uses_modifies.isModifies(13, "x"));
        req(kb_sample->uses_modifies.isModifies(13, "z"));

        req(kb_trivial->uses_modifies.isModifies(14, "cenX"));
        req(kb_trivial->uses_modifies.isModifies(14, "cenY"));
        req(kb_trivial->uses_modifies.isModifies(14, "count"));
        req(kb_trivial->uses_modifies.isModifies(19, "cenX"));
        req(kb_trivial->uses_modifies.isModifies(19, "cenY"));
        req(kb_trivial->uses_modifies.isModifies(19, "flag"));
    }

    SECTION("Modifies(DeclaredStmt, DeclaredVar) for procCall")
    {
        req(kb_sample->uses_modifies.isModifies(10, "x"));
        req(kb_sample->uses_modifies.isModifies(10, "z"));
        req(kb_sample->uses_modifies.isModifies(12, "i"));
        req(kb_sample->uses_modifies.isModifies(12, "x"));
        req(kb_sample->uses_modifies.isModifies(12, "z"));

        req(kb_trivial->uses_modifies.isModifies(2, "cenX"));
        req(kb_trivial->uses_modifies.isModifies(2, "cenY"));
        req(kb_trivial->uses_modifies.isModifies(2, "count"));
        req(kb_trivial->uses_modifies.isModifies(2, "x"));
        req(kb_trivial->uses_modifies.isModifies(2, "y"));
        req(kb_trivial->uses_modifies.isModifies(18, "x"));
        req(kb_trivial->uses_modifies.isModifies(18, "y"));
    }

    SECTION("Modifies(DeclaredStmt, DeclaredVar) negative test cases")
    {
        req(!kb_sample->uses_modifies.isModifies(6, "x"));
        req(!kb_sample->uses_modifies.isModifies(7, "x"));
        req(!kb_sample->uses_modifies.isModifies(15, "z"));
        req(!kb_sample->uses_modifies.isModifies(16, "i"));

        req(!kb_trivial->uses_modifies.isModifies(6, "flag"));
        req(!kb_trivial->uses_modifies.isModifies(14, "flag"));
        req(!kb_trivial->uses_modifies.isModifies(23, "cenX"));
        req(!kb_trivial->uses_modifies.isModifies(23, "cenY"));
    }
}
...
TEST_CASE("Modifies(DeclaredProc, DeclaredVar)")
{
    ...
    {
        req(kb_sample->uses_modifies.isModifies("Example", "i"));
        req(kb_sample->uses_modifies.isModifies("Example", "x"));
        req(kb_sample->uses_modifies.isModifies("Example", "y"));
        req(kb_sample->uses_modifies.isModifies("Example", "z"));
        req(kb_sample->uses_modifies.isModifies("p", "i"));
        req(kb_sample->uses_modifies.isModifies("p", "x"));
        req(kb_sample->uses_modifies.isModifies("p", "z"));
        req(kb_sample->uses_modifies.isModifies("q", "x"));
        req(kb_sample->uses_modifies.isModifies("q", "z"));

        req(kb_trivial->uses_modifies.isModifies("main", "cenX"));
        req(kb_trivial->uses_modifies.isModifies("main", "cenY"));
        req(kb_trivial->uses_modifies.isModifies("main", "count"));
        req(kb_trivial->uses_modifies.isModifies("main", "flag"));
        req(kb_trivial->uses_modifies.isModifies("main", "normSq"));
        req(kb_trivial->uses_modifies.isModifies("main", "x"));
        req(kb_trivial->uses_modifies.isModifies("main", "y"));
        req(kb_trivial->uses_modifies.isModifies("readPoint", "x"));
        req(kb_trivial->uses_modifies.isModifies("readPoint", "y"));
        req(kb_trivial->uses_modifies.isModifies("computeCentroid", "cenX"));
        req(kb_trivial->uses_modifies.isModifies("computeCentroid", "cenY"));
        req(kb_trivial->uses_modifies.isModifies("computeCentroid", "count"));
        req(kb_trivial->uses_modifies.isModifies("computeCentroid", "flag"));
        req(kb_trivial->uses_modifies.isModifies("computeCentroid", "normSq"));
        req(kb_trivial->uses_modifies.isModifies("computeCentroid", "x"));
        req(kb_trivial->uses_modifies.isModifies("computeCentroid", "y"));
    }

    SECTION("Modifies(DeclaredProc, DeclaredVar) negative test cases")
    {
        req(!kb_sample->uses_modifies.isModifies("p", "y"));
        req(!kb_sample->uses_modifies.isModifies("q", "y"));
        req(!kb_sample->uses_modifies.isModifies("q", "i"));


        req(!kb_trivial->uses_modifies.isModifies("readPoint", "cenX"));
        req(!kb_trivial->uses_modifies.isModifies("readPoint", "cenY"));
        req(!kb_trivial->uses_modifies.isModifies("printResults", "cenX"));
        req(!kb_trivial->uses_modifies.isModifies("printResults", "cenY"));
    }
}
...
TEST_CASE("Modifies(DeclaredStmt, AllVar)")
{
    ...
    {
        auto fst_result = kb_sample->uses_modifies.getModifiesVars(1);
        req(fst_result.size() == 1);
        req(fst_result.count("x"));

        auto snd_result = kb_trivial->uses_modifies.getModifiesVars(4);
        req(snd_result.size() == 1);
        req(snd_result.count("x"));
    }
    ...
    {
        auto fst_result = kb_sample->uses_modifies.getModifiesVars(4);
        req(fst_result.size() == 4);
        ...
        auto snd_result = kb_sample->uses_modifies.getModifiesVars(6);
        req(snd_result.size() == 2);
        req(snd_result.count("y"));
        req(snd_result.count("z"));
    }
    ...
    {
        auto fst_result = kb_trivial->uses_modifies.getModifiesVars(2);
        req(fst_result.size() == 7);
        req(fst_result.count("cenX"));
        req(fst_result.count("cenY"));
        req(fst_result.count("count"));
        ...
        auto snd_result = kb_sample->uses_modifies.getModifiesVars(10);
        req(snd_result.size() == 2);
        req(snd_result.count("x"));
        req(snd_result.count("z"));

        auto trd_result = kb_trivial->uses_modifies.getModifiesVars(18);
...
TEST_CASE("Modifies(DeclaredProc, AllVar)")
{
    ...
    {
        auto fst_result = kb_trivial->uses_modifies.getModifiesVars("main");
        req(fst_result.size() == 7);
        req(fst_result.count("cenX"));
        req(fst_result.count("cenY"));
        req(fst_result.count("count"));
        ...
        auto snd_result = kb_trivial->uses_modifies.getModifiesVars("readPoint");
        req(snd_result.size() == 2);
        req(snd_result.count("x"));
        req(snd_result.count("y"));

        auto trd_result = kb_trivial->uses_modifies.getModifiesVars("computeCentroid");
        ...
        auto frh_result = kb_trivial->uses_modifies.getModifiesVars("printResults");
...
TEST_CASE("Modifies(Synonym, DeclaredVar)")
{
    ...
    {
        auto fst_result = kb_trivial->uses_modifies.getModifies(pql::ast::DESIGN_ENT::ASSIGN, "flag");
        req(fst_result.size() == 2);
        req(fst_result.count("1"));
        req(fst_result.count("20"));

        auto snd_result = kb_trivial->uses_modifies.getModifies(pql::ast::DESIGN_ENT::ASSIGN, "cenX");
        req(snd_result.size() == 3);
    ...
    {
        auto fst_result = kb_trivial->uses_modifies.getModifies(pql::ast::DESIGN_ENT::READ, "x");
        req(fst_result.size() == 1);
        req(fst_result.count("4"));

        auto snd_result = kb_trivial->uses_modifies.getModifies(pql::ast::DESIGN_ENT::READ, "y");
        req(snd_result.size() == 1);
    ...
    {
        auto fst_result = kb_trivial->uses_modifies.getModifies(pql::ast::DESIGN_ENT::CALL, "flag");
        req(fst_result.size() == 1);
        req(fst_result.count("2"));

        auto snd_result = kb_trivial->uses_modifies.getModifies(pql::ast::DESIGN_ENT::CALL, "x");
        req(snd_result.size() == 3);
        req(snd_result.count("2"));
        req(snd_result.count("13"));
    ...
    {
        auto fst_result = kb_sample->uses_modifies.getModifies(pql::ast::DESIGN_ENT::IF, "x");
        req(fst_result.size() == 2);
        req(fst_result.count("13"));
        req(fst_result.count("22"));

        auto snd_result = kb_sample->uses_modifies.getModifies(pql::ast::DESIGN_ENT::IF, "i");
        req(snd_result.size() == 1);
        req(snd_result.count("13"));
    }
    ...
    {
        auto fst_result = kb_sample->uses_modifies.getModifies(pql::ast::DESIGN_ENT::WHILE, "y");
        req(fst_result.size() == 1);
        req(fst_result.count("4"));

        auto snd_result = kb_sample->uses_modifies.getModifies(pql::ast::DESIGN_ENT::WHILE, "i");
        req(snd_result.size() == 2);
        req(snd_result.count("4"));
        req(snd_result.count("14"));
    }
    ...
    SECTION("Uses(STMT, DeclaredVar)")
    {
        auto fst_result = kb_sample->uses_modifies.getModifies(pql::ast::DESIGN_ENT::STMT, "x");
        ...
        auto snd_result = kb_trivial->uses_modifies.getModifies(pql::ast::DESIGN_ENT::STMT, "x");
    ...
    SECTION("Uses(PROCEDURE, DeclaredVar)")
    {
        auto fst_result = kb_sample->uses_modifies.getModifies(pql::ast::DESIGN_ENT::PROCEDURE, "y");
        req(fst_result.size() == 1);
        req(fst_result.count("Example"));

        auto snd_result = kb_trivial->uses_modifies.getModifies(pql::ast::DESIGN_ENT::PROCEDURE, "flag");
        req(snd_result.size() == 2);
        req(snd_result.count("computeCentroid"));
        req(snd_result.count("main"));

        auto trd_result = kb_trivial->uses_modifies.getModifies(pql::ast::DESIGN_ENT::PROCEDURE, "x");
