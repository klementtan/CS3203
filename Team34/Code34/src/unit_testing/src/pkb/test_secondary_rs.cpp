...
// Todo: missing atm, have to change the getUses function to handle
// TEST_CASE("Uses(Synonym, WildCard)")
//{
//    SECTION("Uses(assign, DeclaredVar)")
//    {
//        auto fst_result = kb_trivial->uses_modifies.getUses(pql::ast::DESIGN_ENT::ASSIGN, "_");
//        req(fst_result.size() == 12);
//        req(fst_result.count("1"));
//        req(fst_result.count("10"));
//        req(fst_result.count("11"));
//        req(fst_result.count("12"));
//        req(fst_result.count("15"));
//        req(fst_result.count("16"));
//        req(fst_result.count("17"));
//        req(fst_result.count("18"));
...
//    {
//        auto fst_result = kb_trivial->uses_modifies.getUses(pql::ast::DESIGN_ENT::ASSIGN, "flag");
//        req(fst_result.size() == 2);
//        req(fst_result.count("1"));
//        req(fst_result.count("20"));
//
