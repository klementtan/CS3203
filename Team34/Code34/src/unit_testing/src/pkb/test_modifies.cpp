...
auto prog1_m = parseProgram(sample_source);
auto kb_sample_m = processProgram(prog1_m);

auto prog2_m = parseProgram(trivial_source);
auto kb_trivial_m = processProgram(prog2_m);
