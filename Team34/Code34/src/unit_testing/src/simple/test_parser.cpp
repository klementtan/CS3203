...
TEST_CASE("statement parsing -- blocks")
{
    ...
    SECTION("positive cases")
    {
        ...
        TEST_PROG_OK(BEGIN "a=1;if(x == 1)then{b=2;}else{x=0;}c=3;" END, BEGIN "a = 1;if(x == 1)then{b = 2;}else{x = 0;}c = 3;" END);
...
TEST_CASE("statement parsing -- if/while nesting (3 levels)")
{
    ...
    auto b = PROC IF IF IF X ELSE X END ELSE IF X ELSE X END END ELSE IF IF X ELSE X END ELSE IF X ELSE X END END END END;
...
TEST_CASE("statement parsing -- if/while nesting (many levels)")
{
    ...
    auto b = PROC IF IF IF IF X ELSE Y END ELSE IF IF X ELSE Y END ELSE Y END END ELSE IF IF X ELSE Y END ELSE Y END
        END ELSE IF IF IF X ELSE Y END ELSE IF IF X ELSE Y END ELSE IF X ELSE IF X ELSE Y END END END END ELSE IF IF X
        ELSE Y END ELSE IF X ELSE Y END END END END END;
