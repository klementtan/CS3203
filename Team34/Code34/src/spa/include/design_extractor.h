...
namespace pkb
{
    ...
    private:
        ...
        void processExpr(const simple::ast::Expr* expr, Statement* stmt, const std::vector<const simple::ast::Stmt*>& stmt_stack,
            const std::vector<pkb::Procedure*>& proc_stack, const std::vector<Statement*>& call_stack);

        void processUses(const std::string& var, Statement* stmt,
            const std::vector<const simple::ast::Stmt*>& stmt_stack, const std::vector<pkb::Procedure*>& proc_stack, const std::vector<Statement*>& call_stack);
